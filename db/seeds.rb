...
granny4 = GrandmotherOffer.new(user_id: georgina.id, first_name: 'Suzie', last_name: 'Bauwers', username: 'Georgina', return_offer_wish: 'help with Whatsapp', activity_type: 'backing', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Dahlenburg', specialty: 'Knitting', character: 'Warm and welcoming', address: 'Dahlenburg, Germany' )
...
granny5 = GrandmotherOffer.new(user_id: tammy.id, first_name: '', last_name: 'Bauwers', username: 'GrandmaTammy', return_offer_wish: 'help with internet', activity_type: 'knitting', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Cottbus', specialty: 'Baking', character: 'Taking it slow, but reaching the goal', address: 'Cottbus, Germany' )
...
granny6 = GrandmotherOffer.new(user_id: susanna.id, first_name: 'Lola', last_name: 'Bauwers', username: 'Suzana', return_offer_wish: 'help in the garden', activity_type: 'backing bread', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Radebeul', specialty: 'Gaiving grandmother advice', character: 'gentle and polite', address: 'Radebeul, Germany')
...
puts 'creating grandma6'

granny7 = GrandmotherOffer.new(user_id: lena.id, first_name: 'Lila', last_name: 'Sanches', username: 'Granny-Lena', return_offer_wish: 'cake', activity_type: 'fortune telling', description: 'Hello, my name is Lila. I love to cook Lebanese food and share it with others and get to know new people. My biggest hobby is fortune telling, would love to tell you something about your future!', city: 'Rohlstorf', specialty: 'arts and poetry', character: 'wild and free!!', address: 'Rohlstorf, Germany')
...
puts 'creating grandma7'


granny8 = GrandmotherOffer.new(user_id: lora.id, first_name: 'Barbara', last_name: 'Bauwers', username: 'Lora', return_offer_wish: 'help with Whatsapp', activity_type: 'hiking', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Paderborn', specialty: 'being one with nature', character: 'cheerfull and extraordinary', address: 'Paderborn, Germany')
...
puts 'creating grandma8'

granny9 = GrandmotherOffer.new(user_id: lotti.id, first_name: 'Zaneena', last_name: 'Bauwers', username: 'TheOnlyLotti', return_offer_wish: 'beer', activity_type: 'cooking traditional German food', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Gedern', specialty: 'being a family grandma', character: 'good at listening and cheering up!', address: 'Gedern, Germany')
...
puts 'creating grandma9'


granny10 = GrandmotherOffer.new(user_id: sabrina.id, first_name: 'Jenny', last_name: 'Bauwers', username: 'Sabrina', return_offer_wish: 'bottle of nice wine', activity_type: 'garden workshop', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Dachau', specialty: 'coding', character: 'willing to change the world!', address: 'Dachau, Germany' )
