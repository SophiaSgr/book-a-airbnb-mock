...
GrandmotherOffer.create(photo: 'https://img.derwesten.de/img/promi-tv/crop229232648/1894224781-w1200-cv3_2-q85/QueenElizabeth.jpg', user_id: queen.id, first_name: 'Queen', last_name: 'Elizabeth', username: 'realQueenElizabeth', return_offer_wish: 'one big smile', activity_type: 'Playing cricket', description: 'Hi, I am the Queen, but you cann call me Elizabeth. I am very into buisquits and love hanging out with my family. If you like playing cricket, you are more then welcome to join me and a cup of tea. Sincerly - Elizabeth', city: 'London', speciality: 'waving at people, leading a country', character: 'super sweet', address: 'Buckingham Palace London SW1A 1AA')


GrandmotherOffer.create(photo: 'https://images.unsplash.com/photo-1551861568-332d2a6e2330?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1950&q=80', user_id: leslie.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'leeeeeslie', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Munich', speciality: 'telling stories', character: 'greatful', address: 'Rosenstrasse 28, Munich, Germany')


GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1447005497901-b3e9ee359928?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1867&q=80',user_id: hanna.id, first_name: 'Queen', last_name: 'Elizabeth', username: 'Hannah54', return_offer_wish: 'one big smile', activity_type: 'playing cricket', description: 'Hi, I am the Queen, but you cann call me Elizabeth. I am very into buisquits and love hanging out with my family. If you like playing cricket, you are more then welcome to join me and a cup of tea. Sincerly - Elizabeth', city: 'Frankfurt', speciality: 'beaking bread', character: 'mindful', address: 'Bayreuther Strasse 22, Frankfurt, Germany' )

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1505685679686-2490cab6217d?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1950&q=80',user_id: georgina.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'Georgina', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Dahlenburg', speciality: 'Knitting', character: 'Warm and welcoming', address: 'Lietzenburger Straße 47, Dahlenburg, Germany' )

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1577368287217-16ff9373a733?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',user_id: tammy.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'GrandmaTammy', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Cottbus', speciality: 'Baking', character: 'Taking it slow, but reaching the goal', address: 'Charlottenstrasse 82, Cottbus, Germany' )

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1536122522160-72ca6bd783ba?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',user_id: susanna.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'Suzana', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Radebeul', speciality: 'Gaiving grandmother advice', character: 'gentle and polite', address: 'Charlottenstrasse 17, Radebeul, Germany')

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1556889882-73ea40694a98?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1976&q=80',user_id: lena.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'Granny-Lena', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Rohlstorf', speciality: 'arts and peotry', character: 'wild and free!!', address: 'Hans-Grade-Allee 51, Rohlstorf, Germany')

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1581579439002-e29ac578f8d4?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1834&q=80',user_id: lora.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'Lora', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Paderborn', speciality: 'being one with nature', character: 'cheerfull and extraordinary', address: 'Paderborner Strasse 67, Breitenbrunn, Germany')

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1519975258993-60b42d1c2ee2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',user_id: lotti.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'TheOnlyLotti', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Gedern', speciality: 'being a family grandma', character: 'good at listening and cheering up!', address: 'Konstanzer Strasse 34, Gedern, Germany')

GrandmotherOffer.create!(photo: 'https://images.unsplash.com/photo-1504778995644-77707b624d5a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80',user_id: sabrina.id, first_name: 'Leslie', last_name: 'Bauwers', username: 'Sabrina', return_offer_wish: 'cake', activity_type: 'reading stories', description: 'Hello, my name is Leslie, I am 78 years old. I like to tell people some old storys, so they wont be forgotten in the future. If you like to listen and have some cake, feel free to join me.', city: 'Dachau', speciality: 'coding', character: 'willing to change the world!', address: 'Büsingstrasse 28, Dachau, Germany' )
